...
from utils.event_to_attributes_helper import gen_response_relations
...
class EventToRelations(DiscoverableTransform):
    """This transform searches MISP Instance
    for a given event and returns related events"""
