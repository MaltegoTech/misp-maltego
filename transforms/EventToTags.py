...
from utils.event_to_attributes_helper import gen_response_galaxies, gen_response_tags
...
class EventToTags(DiscoverableTransform):
    """This transform searches MISP Instance
    for a given event and returns tags"""
